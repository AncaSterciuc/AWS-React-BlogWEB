...
const BlogDetails = () => {
  ...
  const { data: blog, error} = useFetch('https://tphzg1asgg.execute-api.us-east-1.amazonaws.com/dev' + id);
  ...
  // }
  const handleClick = () => {
    fetch('https://tphzg1asgg.execute-api.us-east-1.amazonaws.com/dev/delete' + blog.id, {
      method: 'DELETE',
        headers: {
